...
public class Controleur implements KeyListener {
	...
	public void keyPressed(KeyEvent e) {
		...
		case 's':
			...
			break;
		//si on appuie sur 'e', commande joueur est ramasse
		case 'e':
			this.commandeEnCours.ramasse = true;
			this.commandeARetourner.ramasse = true;
			break;
		//si on appuie sur '&', commande joueur est consObj1
		case '&':
			this.commandeEnCours.consObj1 = true;
			this.commandeARetourner.consObj1 = true;
			break;
		case 'é':
			this.commandeEnCours.consObj2 = true;
			this.commandeARetourner.consObj2 = true;
			break;
		case '\"':
			this.commandeEnCours.consObj3 = true;
			this.commandeARetourner.consObj3 = true;
			break;
		case '\'':
			this.commandeEnCours.consObj4 = true;
			this.commandeARetourner.consObj4 = true;
			break;
		case '(':
			this.commandeEnCours.consObj5 = true;
			this.commandeARetourner.consObj5 = true;
			break;
		case '-':
			this.commandeEnCours.consObj6 = true;
			this.commandeARetourner.consObj6 = true;
			break;
	...
	public void keyReleased(KeyEvent e) {
		...
		case 's':
			...
			break;
		case 'e':
			this.commandeEnCours.ramasse = false;
			break;
		case '&':
			this.commandeEnCours.consObj1 = false;
			break;
		case 'é':
			this.commandeEnCours.consObj2 = false;
			break;
		case '\"':
			this.commandeEnCours.consObj3 = false;
			break;
		case '\'':
			this.commandeEnCours.consObj4 = false;
			break;
		case '(':
			this.commandeEnCours.consObj5 = false;
			break;
		case '-':
			this.commandeEnCours.consObj6 = false;
			break;
		}
		if(e.getKeyCode() == KeyEvent.VK_SPACE){
